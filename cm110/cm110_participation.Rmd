...
```
Heroku ID: diana.lin@alumni.ubc.ca
```
...
The `app.R` script can be found [here](https://github.com/STAT547-UBC-2019-20/participation-dy-lin/blob/master/cm110/app.R). The [`dash_components.R`](https://github.com/STAT547-UBC-2019-20/participation-dy-lin/blob/master/cm110/dash_components.R) and [`dash_functions.R`](https://github.com/STAT547-UBC-2019-20/participation-dy-lin/blob/master/cm110/dash_functions.R) files are also in the same directory. 
